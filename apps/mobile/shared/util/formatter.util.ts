...
/**
 * Le point UNIQUE où la locale du mobile entre dans les formateurs de `@cmv/shared`.
 *
 ...
 * n'ont pas bougé, donc aucun de leurs trente-deux appelants n'a eu à changer.
 */
