 ...
 * vérifie le CÂBLAGE, qui est la seule chose que le mobile ajoute.
 */
describe("les adaptateurs de formatage du mobile", () => {
  it("formate dans la langue COURANTE d'i18next, pas dans celle du démarrage", async () => {
    ...
    // et le changement de langue ne prendrait qu'au prochain redémarrage de l'app.
