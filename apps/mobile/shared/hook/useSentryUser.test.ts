...
describe("useSentryUser (mobile)", () => {
  ...
  it("efface l'identité à la déconnexion", () => {
    ...
    // C'est la moitié qui compte le plus ici : la session mobile survit à la fermeture de l'app
    // (expo-secure-store). Sans cet effacement, le compte suivant sur ce téléphone hériterait de
    // `u-1`, pas seulement pour un onglet resté ouvert mais jusqu'à la prochaine connexion.
